...
互動式 K 線圖使用 [lightweight-charts](https://github.com/tradingview/lightweight-charts)（Apache-2.0，© TradingView, Inc.），standalone 生產版已 vendored 於 `docs/vendor/lightweight-charts.standalone.production.js`，同源離線載入，無執行期 CDN。
